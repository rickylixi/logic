		...
		\column{0.7\textwidth}
			\begin{figure}[htbp]
				\begin{center}
					...
					\node[circle, draw, text centered, minimum height=2em, fill=green!60!darkgray] (a1) {$s_1$};
					\node[circle, draw, text centered, minimum height=2em, right of=a1, fill=green!60!darkgray] (e1) {$s_2$};
					\node[circle, draw, text centered, minimum height=2em, right of=e1, fill=green!60!darkgray] (a2) {$s_3$};
					\node[circle, draw, text centered, minimum height=2em, right of=a2, fill=green!60!darkgray] (e2) {$s_4$};
...
\begin{figure}[H]
\includegraphics[width=.9\textwidth]{img/dp.pdf}
\end{figure}
\begin{align*}
